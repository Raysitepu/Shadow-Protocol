...
class Soldier(pygame.sprite.Sprite):
    ...
    def move(self, moving_left, moving_right):
        ...
        # Cek tabrakan dengan platform bergerak
        for platform in world.moving_platforms:
            ...
            if platform.rect.colliderect(self.rect.x, self.rect.y + dy, self.width, self.height):
                if self.vel_y < 0:
                    ...
                    # Tambahkan kecepatan platform ke pemain
                    dx += platform.move_speed * platform.move_direction
...
class MovingPlatform(pygame.sprite.Sprite):
    def __init__(self, x, y, width):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.Surface((width * TILE_SIZE, TILE_SIZE))
        self.image.fill((144, 201, 120))  # Warna platform
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        ...
        self.move_counter = 0
        self.move_speed = 2
        self.move_range = 100  # Jarak pergerakan platform
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 6:
                        if tile == 4:  # Platform bergerak
                            platform = MovingPlatform(x * TILE_SIZE, y * TILE_SIZE, 1)
    ...
    if not transition_fade:
        ...
        if transition_fade.fade():
            ...
            if level <= MAX_LEVELS:
                ...
                # Game completed
                draw_text('YOU WIN!', font, WHITE, SCREEN_WIDTH//2-100, SCREEN_HEIGHT//2-50)
                pygame.display.update()
...
while start_game:
    ...
    if not transition_active:
        ...
        exit_group.update()
        world.moving_platforms.update()  # Update platform bergerak
